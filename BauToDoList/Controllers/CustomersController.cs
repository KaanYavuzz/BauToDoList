...
namespace BauToDoList.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public void ExportToExcel()
        {
            ...
            grid.DataBind();
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=Müşteriler.xls");
        ...
        {
            StringWriter sw = new StringWriter();
            sw.WriteLine("ID,Müşteri Adı,Email,Telefon,Faks,URL,Adres,Oluşturulma Tarihi,Oluşturan Kullanıcı,Güncelleme Tarihi,Güncelleyen Kullanıcı");
            Response.ClearContent();
            Response.AddHeader("content-disposition", "attachment;filename=Müşteriler.csv");
